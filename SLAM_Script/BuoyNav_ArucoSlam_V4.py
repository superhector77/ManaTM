...
TANK_WIDTH_X = 5.0   # Width of the physical tank in meters
TANK_LENGTH_Y = 5.0  # Length of the physical tank in meters

GRID_RES = 0.05

# Waypoints mapped to proportional rectangular coordinates
START_POS = (0.1 * TANK_WIDTH_X, 0.9 * TANK_LENGTH_Y, -np.pi/2) 
BUOY1_POS = (0.7 * TANK_WIDTH_X, 0.6 * TANK_LENGTH_Y)
BUOY2_POS = (0.35 * TANK_WIDTH_X, 0.3 * TANK_LENGTH_Y)
